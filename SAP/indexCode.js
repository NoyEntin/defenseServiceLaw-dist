...
//matrix containing the number of sap screenshot each of the pages should open with
//an array for each chapter
//which contains an array for each page
...
function chapterManager() {
    ...
    $("#practice-screen-content").append("<img src='media/sapScreenshots/" + currScreen + ".png' id='screen-img' class='fullscreen'/>");
        ...
        switch (interactionType) {
            case "click":
                ...
                $("#clickable").on("click", function (event) {
                    showNextSection();
                    if (isChangeScreen) {
                        $("#screen-img").attr("src", "media/sapScreenshots/" + ++currScreen + ".png");
                    }
                    interactionManager();
                });
                break;
...
/*
            ...
            ===========
            description:
            * if color scheme button is set to change to blue, update color variables to blue version
            * if color scheme button is set to change to orange, update color variables to orange version
...
function changeColor(event) {
    if ($("#color-scheme").hasClass("change-to-blue")) {
        document.documentElement.style.setProperty('--header-color1', '#48CAE4');
        document.documentElement.style.setProperty('--sidebar-color2', '#023E8A');
        document.documentElement.style.setProperty('--start-btn-color3', '#00B4D8');
        document.documentElement.style.setProperty('--scrollbar-color4', '#0096C7');
        document.documentElement.style.setProperty('--menu-item-color5', '#0077B6');
        document.documentElement.style.setProperty('--hover-color6', '#005481');
        $(".sap-icon").attr("src", "media/sapBlue.png");
        $("body").css("background-image", "url(media/backgroundBlue.png)");
        $("#color-scheme").removeClass("change-to-blue");
        $("#color-scheme").addClass("change-to-orange");
    } else if ($("#color-scheme").hasClass("change-to-orange")) {
        document.documentElement.style.setProperty('--header-color1', '#feb100');
        document.documentElement.style.setProperty('--sidebar-color2', '#c7700b');
        document.documentElement.style.setProperty('--start-btn-color3', '#e29200');
        document.documentElement.style.setProperty('--scrollbar-color4', '#e3861b');
        document.documentElement.style.setProperty('--menu-item-color5', '#ca7518');
        document.documentElement.style.setProperty('--hover-color6', '#aa6214');
        $(".sap-icon").attr("src", "media/sapOrange.png");
        $("body").css("background-image", "url(media/backgroundOrange.png)");
        $("#color-scheme").removeClass("change-to-orange");
        $("#color-scheme").addClass("change-to-blue");
    }
}
